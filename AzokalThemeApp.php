 ...
 * Description
 *
 * @file AzokalThemeApp.php
 * @copyright REZO ZERO 2014
 * @author Ambroise Maupate
 */

namespace Themes\AzokalTheme;
...
/**
 * AzokalThemeApp class
 */
class AzokalThemeApp extends FrontendController
{
    const VERSION = '1.0.1';

    protected static $themeName = 'RZ Azokal theme';
    protected static $themeAuthor = 'REZO ZERO';
    protected static $themeCopyright = 'REZO ZERO';
    protected static $themeDir = 'AzokalTheme';
